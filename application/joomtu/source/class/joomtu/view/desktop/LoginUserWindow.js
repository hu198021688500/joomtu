 ...
 * login user window
 */
qx.Class.define("joomtu.view.desktop.LoginUserWindow", {
	...
	construct : function(controller) {
		this.base(arguments, this.tr("Login User"), "icon/16/actions/document-new.png");
	...
	members : {
		...
		_addContent : function() {
			...
			this.__urlTextfield = new qx.ui.form.TextField().set({
						required : true
					});
			this.__form.add(this.__urlTextfield, this.tr("URL"),
					qx.util.Validate.checkUrl);

			// add the button
			var addButton = new qx.ui.form.Button(this.tr("Add"),
		...
		/**
		 * Handles button clicks on 'Add' button or/and pressing enter
		 * key on textfields
		 * 
		 * @param e
		 *            {qx.event.type.Event} Execute event
		 */
		_addFeed : function(e) {
	...
	destruct : function() {
		...
		this._disposeObjects("__controller", "__titleTextfield",
				"__urlTextfield", "this.__form");
	}
});